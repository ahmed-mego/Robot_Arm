...
#include "robot_interfaces/msg/detail/motor_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::MotorStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::MotorStatus & ros_message)
{
  // Member: my_location
  cdr >> ros_message.my_location;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::MotorStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::MotorStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::MotorStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<robot_interfaces::msg::MotorStatus>()
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_MotorStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, MotorStatus)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_MotorStatus__handle;
}
