...
class Motors(metaclass=Metaclass_Motors):
    ...
    _fields_and_field_types = {
        'steps': 'sequence<int64>',
        'dir': 'sequence<boolean>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.steps = array.array('q', kwargs.get('steps', []))
    ...
    def steps(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'q', \
                "The 'steps' array.array() must have the type code of 'q'"
            self._steps = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'steps' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
        self._steps = array.array('q', value)
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'dir' field must be a set or sequence and each value of type 'bool'"
        self._dir = value
