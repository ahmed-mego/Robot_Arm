    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_interfaces.msg.MotorStatus')
            logger.debug(
...
class MotorStatus(metaclass=Metaclass_MotorStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.my_location = kwargs.get('my_location', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.my_location != other.my_location:
            return False
        return True
    ...
    def my_location(self, value):
        if __debug__:
            assert \
                ...
                "The 'my_location' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'my_location' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._my_location = value
