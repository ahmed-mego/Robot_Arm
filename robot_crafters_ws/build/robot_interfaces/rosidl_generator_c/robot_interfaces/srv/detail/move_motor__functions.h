...
#ifndef ROBOT_INTERFACES__SRV__DETAIL__MOVE_MOTOR__FUNCTIONS_H_
#define ROBOT_INTERFACES__SRV__DETAIL__MOVE_MOTOR__FUNCTIONS_H_
...
/// Initialize srv/MoveMotor message.
/**
...
/// Finalize srv/MoveMotor message.
/**
...
/// Create srv/MoveMotor message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_interfaces__srv__MoveMotor_Request__init().
...
/// Destroy srv/MoveMotor message.
/**
 * It calls
 * robot_interfaces__srv__MoveMotor_Request__fini()
...
/// Check for srv/MoveMotor message equality.
/**
...
/// Initialize array of srv/MoveMotor messages.
/**
...
/// Finalize array of srv/MoveMotor messages.
/**
 * It calls
 * robot_interfaces__srv__MoveMotor_Request__fini()
...
/// Create array of srv/MoveMotor messages.
/**
 * It allocates the memory for the array and calls
 * robot_interfaces__srv__MoveMotor_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MoveMotor messages.
/**
 * It calls
 * robot_interfaces__srv__MoveMotor_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MoveMotor message array equality.
/**
...
/// Copy an array of srv/MoveMotor messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_interfaces__srv__MoveMotor_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_interfaces
...
/**
 * It calls
 * robot_interfaces__srv__MoveMotor_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robot_interfaces__srv__MoveMotor_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_interfaces
...
/**
 * It calls
 * robot_interfaces__srv__MoveMotor_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_INTERFACES__SRV__DETAIL__MOVE_MOTOR__FUNCTIONS_H_
