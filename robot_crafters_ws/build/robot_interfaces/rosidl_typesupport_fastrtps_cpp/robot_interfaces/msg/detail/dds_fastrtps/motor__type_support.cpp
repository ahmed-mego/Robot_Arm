...
#include "robot_interfaces/msg/detail/motor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::Motor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::Motor & ros_message)
{
  // Member: steps
  cdr >> ros_message.steps;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::Motor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::Motor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::Motor *>(
    untyped_ros_message);
...
get_message_type_support_handle<robot_interfaces::msg::Motor>()
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_Motor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, Motor)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_Motor__handle;
}
