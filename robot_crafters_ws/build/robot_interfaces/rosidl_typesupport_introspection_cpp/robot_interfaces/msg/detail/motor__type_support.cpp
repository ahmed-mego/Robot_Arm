...
{
  new (message_memory) robot_interfaces::msg::Motor(_init);
}

void Motor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces::msg::Motor *>(message_memory);
  typed_message->~Motor();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Motor_message_member_array[2] = {
  {
    ...
    offsetof(robot_interfaces::msg::Motor, steps),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::Motor, dir),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Motor_message_members = {
  ...
  "Motor",  // message name
  2,  // number of fields
  sizeof(robot_interfaces::msg::Motor),
...
{
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::Motor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, msg, Motor)() {
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::Motor_message_type_support_handle;
}
