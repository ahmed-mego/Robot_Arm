...
{
  new (message_memory) robot_interfaces::msg::MotorStatus(_init);
}

void MotorStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces::msg::MotorStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorStatus_message_member_array[1] = {
  {
    ...
    offsetof(robot_interfaces::msg::MotorStatus, my_location),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(robot_interfaces::msg::MotorStatus),
...
{
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, msg, MotorStatus)() {
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorStatus_message_type_support_handle;
}
