...
bool robot_interfaces__msg__motors__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._motors.Motors", full_classname_dest, 35) == 0);
  }
  robot_interfaces__msg__Motors * ros_message = _ros_message;
  {  // steps
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int64_t * dest = ros_message->steps.data;
  ...
  {  // dir
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      bool * dest = ros_message->dir.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'dir'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * robot_interfaces__msg__motors__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._motors");
  ...
  {  // steps
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "steps");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->steps.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int64_t * src = &(ros_message->steps.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->steps.size * sizeof(int64_t));
      assert(data != NULL);
