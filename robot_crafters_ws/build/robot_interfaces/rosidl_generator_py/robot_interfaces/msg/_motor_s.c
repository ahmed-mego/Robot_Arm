...
bool robot_interfaces__msg__motor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._motor.Motor", full_classname_dest, 33) == 0);
  }
  robot_interfaces__msg__Motor * ros_message = _ros_message;
  {  // steps
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * robot_interfaces__msg__motor__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Motor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._motor");
  ...
  robot_interfaces__msg__Motor * ros_message = (robot_interfaces__msg__Motor *)raw_ros_message;
  {  // steps
    PyObject * field = NULL;
