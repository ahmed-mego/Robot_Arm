...
#include "robot_interfaces/msg/detail/motor_status__rosidl_typesupport_fastrtps_c.h"
...
using _MotorStatus__ros_msg_type = robot_interfaces__msg__MotorStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: my_location
  {
    cdr << ros_message->my_location;
  }
...
size_t get_serialized_size_robot_interfaces__msg__MotorStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name my_location
  {
    size_t item_size = sizeof(ros_message->my_location);
...
static uint32_t _MotorStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__MotorStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__msg__MotorStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces__msg__MotorStatus;
    is_plain =
      (
      offsetof(DataType, my_location) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _MotorStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__msg__MotorStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, msg, MotorStatus)() {
